  ...
  <div class="card-body">
    ...
    <ul class="list-group list-group-flush">
      <li class="list-group-item <?php if(isset($_GET['my_orders'])){ echo "active";} ?>">
         <a href="my_account.php?my_orders" class="list-group-item-action text-white">
           <i class="fa fa-list"></i> My Orders
         </a>
      </li>

      <li class="list-group-item <?php if(isset($_GET['pay_offline'])){ echo "active";} ?>">
         <a href="my_account.php?pay_offline" class="list-group-item-action text-white">
           <i class="fa fa-bolt"></i> Pay Offline
         </a>
      </li>

      <li class="list-group-item <?php if(isset($_GET['edit_account'])){ echo "active";} ?>">
         <a href="my_account.php?edit_account" class="list-group-item-action text-white">
           <i class="fa fa-pencil"></i> Edit Account
         </a>
      </li>

      <li class="list-group-item <?php if(isset($_GET['change_pass'])){ echo "active";} ?>">
         <a href="my_account.php?change_pass" class="list-group-item-action text-white">
           <i class="fa fa-user"></i> Change Password
         </a>
      </li>

      <li class="list-group-item <?php if(isset($_GET['delete_account'])){ echo "active";} ?>">
         <a href="my_account.php?delete_account" class="list-group-item-action text-white">
           <i class="fa fa-trash-o"></i> Delete Account
         </a>
      </li>

      <li class="list-group-item">
         <a href="logout.php" class="list-group-item-action text-white">
